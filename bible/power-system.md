# Power System: Contract Force, Seams, and the Roll-Answer

## System in One Sentence

A contract is durable when its terms are clearly understood, freely accepted, witnessed, recorded, and attached to a consequence that can survive the death of the signer; every stronger effect costs the reader, signer, witness, or community a specific duty.

There is no general mana pool, level screen, class list, or automatic skill purchase. Power is legal, social, and physical. A person can be formidable without being a dragon.
...
3. **Witness:** At least one witness must be able to recall the exchange and be responsible for saying what was promised. A witness may be human, dragon, or a recognized civic recorder.
...
A human-to-human sale, loan, lease, marriage settlement, apprenticeship, or will. It has magic only when witnessed and recorded. It can still be fraudulent, coerced, or misunderstood.

### Scale Contract

A contract with a dragon House, dragon territory, or dragon-held resource as a party. A scale contract can bind descendants, land use, water, labor, or succession if the continuation is clearly stated and publicly registered. A dragon's bloodline does not make every clause just or valid.
...
**Inheritance echo** is the social and legal effect by which an accepted continuation clause begins to govern people who never signed it.

The process requires all of the following:

1. A continuation clause is attached to a real contract.
2. A court, civic assembly, guild, or dragon notary accepts the clause as a general rule rather than a private exception.
3. The accepted wording is copied into a precedent or public record.
4. Families, lenders, guilds, and officials begin to rely on that precedent.
5. Later disputes use it as if it were ordinary inheritance law.

The result is not a mind-control spell. It is a durable change in what people believe they owe. A child may be treated as a debtor because every adult around the child has accepted the precedent. A district may lose a customary right because a clerk no longer knows how to explain the old rule.

A person can sometimes reject an echo without losing ordinary rights, but rejection becomes expensive when lenders, guilds, or dragon houses treat the refusal as a breach. The story keeps that material pressure visible.

## Seams and the Roll-Answer
...
> Carried after death: the consequence the record currently assigns to a successor.
...
1. **A reading can be accurate and still wrong.** It reports the present legal effect of the record in front of the auditor. If that record is itself the altered or incomplete copy, the three lines are perfectly correct about a false document. A reading is taken against the record the recognized body is currently acting on, not against an original leaf sealed away in a custody sleeve, and not against a private comparison copy. Chapters 1–10 of Volume 1 are built on this rule: the comparison copy disagrees with the summary, and after the Chapter 8 ruling the Roll-Answer is taken against the operative filed Venn record, which now carries the court's own public-necessity gloss. The three lines are therefore correct about what the court has just done and completely silent about the fraud that put that sentence into the file.
...
Before any magic, Marek can compare a file to its copy, identify an impossible witness list, notice a missing seal, and interview a person without letting a title decide what happened. He is fallible: trained clerks can be technically correct and politically biased.

**Cost:** Ordinary time, wages, reputation, and exposure to the consequences of making a dispute visible. A mistake can delay a burial, a sale, or a winter's ration.

### Stage 1: Seam-Sight

After surviving a genuine audit and learning to keep a witness focused, Marek can see one active seam and its immediate beneficiaries. He can tell that a clause is carrying a consequence to someone who did not sign it, but not who first introduced it.

**Cost:** Counterpressure, physical fatigue, and a temporary obligation. A forced reading can make him speak a clause's exact name while he is under its influence.

**Limit:** A false but widely believed chain looks real. He cannot read private intention or see a seam that has not been recorded in some material form.
...
By studying the same dispute across several genuine records, Marek can reconstruct the reasoning that carried a clause from one court to another. He can hear the older legal arguments in their recorded order.

**Cost:** He temporarily borrows a dead clerk's or witness's remembered method. A reading may cost him a skill, a day of personal memory, or a painful piece of his mother's history. The loss is not an abstract experience percentage; it changes what he can remember and who trusts his judgment.

**Limit:** He can reconstruct only what was recorded or reliably remembered. His own expectation can contaminate the reconstruction, especially when he wants one answer.

### Stage 4: First-Hearing Auditor

Marek can call a **clear hearing** in which every living party named by a contract must be given a real chance to hear, question, and answer the disputed term. The hearing can cross a local court boundary if the relevant institutions agree to recognize it.

**Cost:** Marek becomes a named party. He cannot hide behind the office, and the outcome binds him as well as the people he summoned. A hostile audience can use his own history against him.

**Limit:** The hearing forces acknowledgment, not honesty. A person may answer truthfully but still be coerced, or lie within a loophole that the original law recognizes.

### Stage 5: Covenant Architect

Marek can draft a rule that works across several jurisdictions by making the duties, witnesses, review date, and refusal procedure explicit. He cannot impose the rule; representatives of the affected people must accept it through a quorum or deliberate public acts.

**Cost:** He gives up exclusive control over the rule. A successful covenant can continue without him, which means he loses the feeling of being indispensable and must accept that other people may revise his work.

**Limit:** A rule with too small a quorum can be captured; one with too large a quorum can become impossible to revise. Every draft carries a political failure mode.

### Stage 6: Distributed Witness
...
- **Public correction:** A new clear hearing can narrow a precedent if the affected parties are named and the institutions agree to recognize the result.
- **Withdrawal of recognition:** A local assembly or dragon House can withdraw its cooperation from a disputed contract, temporarily making the contract unenforceable in that jurisdiction.
- **Material separation:** A forged or altered copy can be exposed by comparing paper, ink, heat damage, witness marks, and the sequence of filing dates. Destroying one artifact does not erase the others.
- **Consent withdrawal:** A living heir can refuse a continuation before accepting it, provided the refusal is recorded and does not violate a separate valid obligation.
- **Consequence transfer:** A valid exception can move a burden, not make it vanish. This is often the honest beginning of reform.
- **Death:** A dragon's death can suspend a seal if no one inherits the duty, but it does not automatically transfer authority to a blood relative. A dead principal's unresolved obligations require a public settlement.
- **Violence:** Physical destruction can interrupt a contract's witness chain, but it cannot reliably erase social belief. It usually creates a new dispute and damages the people who depend on the record.

## Growth Rules for Writing

1. A new stage should be earned through at least one failure, not granted by a mysterious voice.
2. Every strong reading should leave a practical limitation visible within the same scene or shortly after it.
3. No solution may rely on a hidden clause Marek has not discovered through evidence.
4. Dragon strength is not an excuse to bypass consent. A dragon can threaten, deceive, or use ordinary politics, but the contract rules remain active.
5. A legal victory must answer who is protected, who pays, what record remains, and what can be appealed.
6. The Roll-Answer can clarify the immediate legal effect once. It must not become an oracle, a menu of skills, or a substitute for witness work.
