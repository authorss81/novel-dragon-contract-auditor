...
- Marek is at Stage 0 at the opening. His first unstable Seam-Sight and first Roll-Answer are earned by exercising the limited Venn audit authorized in Chapter 7 at the Chapter 8 rehearing; permission alone does not produce the reading. The first reading is shallow and leaves fatigue, counterpressure, an ash taste, and a headache that persists into the next day or two, plus a temporary inability to lie about one named obligation. No counter-seal or Stage 2 ability appears in Volume 1.
- A reading can be accurate and still wrong: it reports the present legal effect of the record in front of the auditor, so an altered or incomplete record produces a correct answer about a false document. Volume 1 opens on exactly this gap.
